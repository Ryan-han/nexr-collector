package com.ktnexr.flume.source.uftp;

import com.ktnexr.flume.source.util.UFtpUtil;
...
public class FtpTask extends UFtp<ArrayList> {
    ...
    public FtpTask(Context ctx) throws Exception  {
        ...
        //config.setDefaultDateFormatStr("MM dd HH:mm");
        //config.setRecentDateFormatStr("MM dd HH:mm");
    }
...
//                    bis = new BufferedInputStream(ftpClient.retrieveFileStream(downloadFileName));
//
...
//                    bos.close();
                    ...
                    //UFtpUtil.transFileEncoding(localDir + "/" + downloadFileName, "EUC-KR" , localDir + "/" + downloadFileName+"_", "UTF-8");
